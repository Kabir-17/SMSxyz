...
export interface IStudentDayAttendanceModel extends Model<IStudentDayAttendanceDocument> {
    ...
    finalizeForDate(schoolId: Types.ObjectId, date: Date, dateKey: string, finalizeTime: string, timezone?: string): Promise<void>;
    getStatusMap(schoolId: Types.ObjectId, dateKeys: string[]): Promise<Map<string, IStudentDayAttendanceDocument>>;
}
//# sourceMappingURL=day-attendance.interface.d.ts.map