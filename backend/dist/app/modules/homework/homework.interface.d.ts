...
export interface IHomeworkModel extends Model<IHomeworkDocument> {
    ...
    getHomeworkCalendar(schoolId: string, startDate: Date, endDate: Date, grade?: number, section?: string): Promise<IHomeworkCalendar>;
...
export interface IHomeworkResponse {
    ...
    mySubmission?: IHomeworkSubmissionResponse;
}
...
//# sourceMappingURL=homework.interface.d.ts.map