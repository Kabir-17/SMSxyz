...
export interface IGradeModel extends Model<IGradeDocument> {
    ...
    calculateSubjectAverage(studentId: string, subjectId: string, academicYear: string, semester?: string): Promise<ISubjectGrade>;
    getStudentReportCard(studentId: string, academicYear: string, semester?: string): Promise<IReportCard>;
    getClassGradeStats(schoolId: string, grade: number, section: string, subjectId: string, academicYear: string): Promise<IClassGradeStats>;
    getGradingAnalytics(schoolId: string, filters?: IGradeFilters): Promise<IGradingAnalytics>;
}
...
//# sourceMappingURL=grade.interface.d.ts.map