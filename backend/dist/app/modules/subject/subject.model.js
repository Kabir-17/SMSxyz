...
subjectSchema.methods.getTeacherCount = function () {
    return this.teachers.length;
};
subjectSchema.methods.isOfferedInGrade = function (grade) {
...
subjectSchema.statics.findByGrade = function (schoolId, grade) {
