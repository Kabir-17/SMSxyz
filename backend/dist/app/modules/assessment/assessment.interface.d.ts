...
export interface IAssessmentCategoryDocument extends IAssessmentCategory, Document {
    id: string;
}
export interface IAssessmentCategoryModel extends Model<IAssessmentCategoryDocument> {
}
...
export interface IAssessmentAdminPreferenceDocument extends IAssessmentAdminPreference, Document {
    id: string;
}
export interface IAssessmentAdminPreferenceModel extends Model<IAssessmentAdminPreferenceDocument> {
}
