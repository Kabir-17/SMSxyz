      ...
      <main className="pt-4 pb-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Routes>
            ...
            <Route
              path="/disciplinary"
              element={<StudentDisciplinaryActions />}
            />
            <Route
              path="/messages"
              element={
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
        ...
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-6 mb-6">
          ...
          <div className="mt-4 p-3 bg-indigo-50 rounded-lg border border-indigo-200">
            <p className="text-sm text-indigo-800 text-center">
              <strong>Study Tip:</strong> Check your schedule first, complete
              homework early, and review grades regularly!
            </p>
          </div>
        </div>
            ...
            <div className="space-y-2 sm:space-y-3">
              {dashboardData?.upcomingAssignments
                ...
                .map((assignment: any, index: number) => (
                  <div
                    key={index}
                    className="p-3 bg-gray-50 rounded-lg border hover:border-yellow-200 transition-colors"
                  >
        ...
        <div className="mt-6">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
            ...
            <EventCalendar onEventClick={(_event) => {}} />
          </div>
        </div>
      </div>
    </div>
...
const FeeStatusCard: React.FC = () => {
  ...
  const loadFeeStatus = async () => {
    try {
      ...
      const studentId =
        studentData?.student?.studentId || studentData?.studentId;
      ...
      const response = await apiService.fee.getStudentFeeStatusDetailed(
        studentId
      );
      if (response.data) {
  ...
  const admissionRemaining =
    feeStatus.admissionFeeAmount - feeStatus.admissionFeePaid;
            ...
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-xs text-yellow-700 mt-1">
                  Due Date:{" "}
                  {new Date(feeStatus.nextDue.dueDate).toLocaleDateString()}
